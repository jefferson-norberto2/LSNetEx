...
parser.add_argument('--train_root', type=str, default=f'{root}/{task}_dataset/train/NJUNLPR', help='the train images root')
parser.add_argument('--val_root', type=str, default=f'{root}/{task}_dataset/val/NJUNLPR', help='the val images root')
parser.add_argument('--save_path', type=str, default=f'runs/train/{save_path}/', help='the path to save models and logs')
parser.add_argument('--wandb_mode', type=str, default=f'online', help='type mode (disabled, offline or online)')
