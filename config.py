...
parser.add_argument('--train_root', type=str, default='Datasets/RGBT', help='the train images root')
parser.add_argument('--val_root', type=str, default='Datasets/RGBT', help='the val images root')
