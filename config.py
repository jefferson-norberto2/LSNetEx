...
parser.add_argument('--save_path', type=str, default='Runs/v3_large_tl/', help='the path to save models and logs')
...
parser.add_argument('--model_path', type=str, default='Runs/v3_large_tl/Net_epoch_best.pth', help='path to model')
