...
parser.add_argument('--network', type=int, default=2, help='Choose network structure: 0 -> V3 Large, 1 -> V3 Small, 2 -> V2 Pytorch')
...
parser.add_argument('--save_path', type=str, default='Runs/v2_pytorch_2/', help='the path to save models and logs')
