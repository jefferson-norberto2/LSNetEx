...
parser.add_argument('--network', type=int, default=3, help='Choose network encoder: 0 -> V2 Acrticle, 1 -> V2 Pytorch, 3 -> V3 Small, 4 -> V3 Large')
...
parser.add_argument('--save_path', type=str, default='Runs/train/v3_small/', help='the path to save models and logs')
