...
parser.add_argument('--network', type=int, default=0, help='Choise network structure: 0 - V3Large, 1 - V3Small, 2 - V2')
...
parser.add_argument('--model_path', type=str, default='Runs/train1/Net_epoch_best.pth', help='path to model')
